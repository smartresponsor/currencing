...
if ('' !== $templateBridgeGate && !str_contains($templateBridgeGate, 'Currencing template bridge contract gate')) {
    $errors[] = 'tools/currencing-template-bridge-contract-check.php must contain the M22 template bridge contract gate.';
}
...
if ('' !== $currencyEntity && !str_contains($currencyEntity, "name: 'currency_currency'")) {
